const STEPS = [
  {
    number: 1,
    text: "같은 사람에게 끌리고, 같은 방식으로 상처받아요. 상담을 받아봐도 뭔가 남지 않았다면, 원인을 아직 못 만난 거예요.",
  },
  {
    number: 2,
    text: "기분 스튜디오는 당신의 사고 패턴, 핵심 신념, 감정 반응을 데이터로 풀어요. 막연한 대화가 아니라, 구조가 있는 해킹이에요.",
  },
  {
    number: 3,
    text: "원인을 알면 패턴은 깨져요. 반복에서 벗어나는 거예요. 내가 진짜 원하는 걸 알게 되는 거예요. 거기가 도착지예요.",
  },
];
