  ...
  return (
    <div className="mx-auto max-w-lg space-y-8 pb-40">
      ...
      <div className="rounded-xl border-2 border-[var(--foreground)] bg-white p-6">
        <p className="text-sm text-[var(--foreground)]/60 mb-3">정식 오픈 예정 가격</p>
      ...
      {/* 하단 고정 대기신청 바 (정식 오픈 전 — 결제 비활성) */}
      <div className="fixed inset-x-0 bottom-0 z-40 border-t-2 border-[var(--foreground)] bg-white/95 px-4 py-3 backdrop-blur">
        <div className="mx-auto flex max-w-lg items-center justify-between gap-3">
          <div className="leading-tight">
            <p className="text-xs text-[var(--foreground)]/60">정식 오픈 예정</p>
            <p className="text-sm font-semibold text-[var(--foreground)]">
              대기 신청하면 오픈 시 특별가로 알려드려요
            </p>
          </div>
          <Link
            href="/waitlist"
            className="flex-shrink-0 rounded-full border-2 border-[var(--foreground)] bg-[var(--foreground)] px-5 py-2.5 text-sm font-semibold text-white"
          >
            대기 신청 →
          </Link>
        </div>
