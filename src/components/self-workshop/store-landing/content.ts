...
export const CREATOR_STORY_PARAGRAPHS: { text: string; highlight?: boolean }[] = [
  ...
  {
    text: "심리 상담 워크북은 그렇게 시작됐습니다.",
    highlight: true,
  },
  {
    text: "심리 상담 워크북은 실습을 통해 문제 상황을 발견하고, 인지행동 이론에 따라 분석함으로써 그 함정에서 빠져나오는 법을 배울 수 있습니다. 몇 번의 훈련을 거치면 스스로도 할 수 있어요. 이 워크북이 퍼포먼스의 한계를 없애고, 새로운 세계를 열어주는 문이 되길 바랍니다.",
  },
];
...
export const LANDING_FAQ: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "심리 상담 워크북은 치료 목적이 아니며, 스스로의 마음을 이해하고 대처하는 도구입니다. 이미 진단을 받으셨다면 전문의·상담사 상담과 병행해서 사용해 주세요. 워크북에 정리된 패턴과 기록은 전문가와 이야기할 때 유용한 자료가 될 수 있습니다.",
  },
  {
