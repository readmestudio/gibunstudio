...
export const SOLUTION_HIGHLIGHTS = [
  ...
  },
  {
    ...
    description:
      "진단 → 패턴 분석 → 핵심 믿음 발굴 → 대처 계획까지, 상담심리학의 대표 프레임(CBT)을 그대로 따라 단계별로 이어집니다.",
  },
  {
...
/* ── 창작자 스토리 ── */
export const CREATOR_STORY_PARAGRAPHS = [
  "저는 10년간 스타트업, 실리콘밸리 스타트업에서 일했습니다. 매년 높아지는 기대치와 업무 강도 속에서, 정작 어려웠던 건 업무 자체가 아니라 그 안에서 밀려오는 압박감, 스트레스, 불안감을 다스리는 일이었습니다. 이 불편한 마음들이 제 퍼포먼스를 해치는 느낌마저 들었어요.",
  "비싼 심리 상담도 받아보고, 명상 리트릿도 떠나봤습니다. 그런데 모든 게 그때뿐이었습니다. 결국 저 스스로 마음의 문제를 들여다보고 해결할 수 있어야 했습니다. 그 도구를 만들고 싶었습니다.",
  "마음챙김 워크북은 그렇게 시작됐습니다.",
];
