...
export function ReportCard({
  ...
  // 카드 5: 직업군/만남장소 미니카드 + 배우자 채널 미니카드
  const showPartnerJobs = cardNumber === 5 && metadata?.partner_jobs;
  const showPartnerChannels = cardNumber === 5 && metadata?.partner_channels && metadata.partner_channels.length > 0;
