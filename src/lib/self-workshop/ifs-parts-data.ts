...
export const PARTS_DISCOVERY_STEPS: PartDiscoveryStep[] = [
  ...
  },
  {
    id: "real_want",
    opening:
      "'{대사}' — 이렇게 말하던 그 마음은, 사실은 나를 위한 마음이었을지도 몰라요. 그 마음은 나에게 어떤 말을 듣고 싶었을까요? 무엇을 지켜주고 싶었던 걸까요? (예: '지금도 충분히 잘하고 있어'라는 인정, '실수해도 괜찮아'라는 안심처럼요)",
    // topic 없음 — 정적. {대사}=#4 답으로 치환. '진짜 원한 것'을
    // '듣고 싶었던 말/지키려던 것'으로 풀어 답하기 쉽게 (IFS 긍정 의도).
    maxFollowups: 1,
  },
  {
    id: "origin",
