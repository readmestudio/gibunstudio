...
export const TEST_CATALOG: TestInfo[] = [
  /* ───── 무료 검사 ───── */
  {
    ...
    title: "내 마음 배역 진단",
    description:
      "최근 마음이 불편했던 한 순간으로, 내 안에서 동시에 목소리를 내는 여러 '배역'을 만나봐요. 3분, 가입 없이 무료.",
    price: "검사·리포트 무료 / 관계 해설 리포트 ₩19,900",
    testHref: "/minds",
    notifyOnly: false,
    detail: {
      hero: {
        hook: "내 안엔 몇 명이\n살고 있을까?",
        tagline: "작은 실수에도 자책하고 몰아붙이는 마음, 그 정체를 만나봐요",
      },
      socialProof: [
        "IFS(내면가족체계) 이론 기반 마음 분석",
        "가입 없이 3분, 완전 무료",
      ],
      painPoints: [
        "작은 실수에도 한참을 자책한다",
        "더 잘해야 한다고 끊임없이 스스로를 몰아붙인다",
        "내 감정이 왜 이렇게 복잡한지 모르겠다",
      ],
      cause: {
        before: "내가 유난해서가 아니라",
        highlight: "마음속 여러 배역이 저마다 목소리를 내기 때문입니다",
      },
      insightLine:
        "리더·빌런·난봉꾼·관리자·추방자 — 지금 내 무대에 오른 배역을 알아야 휘둘리지 않아요",
      intro: {
        headline: "마음은 하나의 덩어리가 아니에요",
        body: "심리학은 마음을 각자 다른 역할을 맡은 여러 배역이 모여 사는 작은 가족으로 봅니다. 최근 마음이 흔들렸던 한 순간을 들려주면, 그 안에서 동시에 움직인 마음들을 캐릭터로 만나볼 수 있어요.",
      },
      testIntro: {
        question: "그냥 기분 탓 아니야?",
        answer: "한 순간에도 여러 마음이 동시에 움직여요.",
        explanation:
          "자책하는 마음, 더 몰아붙이는 마음, 그만 쉬고 싶은 마음이 한꺼번에 부딪칩니다. 이 마음들을 배역으로 나눠 보면, 내가 왜 그렇게 반응했는지가 또렷해져요.",
      },
      specs: {
        questions: "5문항 대화",
        duration: "약 3분",
        target: "마음이 자주 복잡하고 무거운 누구나",
      },
      deliverables: [
        "내 안에 사는 마음 캐릭터 명단",
        "각 마음의 목소리(대사)와 내 답변 인용",
        "지금 내 무대에 오른 마음들 요약",
      ],
      steps: [
        "최근 마음이 불편했던 한 순간을 떠올려 적기",
        "그 순간 올라온 여러 감정·생각을 답하기",
        "AI가 내 안의 마음들을 배역으로 정리해 리포트로 보여줌",
      ],
      faq: [
        {
          q: "로그인이나 가입이 필요한가요?",
          a: "아니요. 이메일 또는 카카오로 가볍게 받기만 하면 바로 결과를 볼 수 있어요.",
        },
        {
          q: "결과는 사람마다 다른가요?",
          a: "네. 답변을 AI가 분석해 그 순간의 마음들을 캐릭터로 만들기 때문에, 입력에 따라 매번 달라집니다.",
        },
        {
          q: "유료 리포트는 뭐가 다른가요?",
          a: "무료 진단은 마음 명단까지 보여주고, 관계 해설 리포트(₩19,900)에서 누가 리더·빌런·난봉꾼·관리자·추방자인지 5배역 배역표와 그들의 관계·방어기제·마음의 목소리·맞춤 처방까지 풀어드려요.",
        },
      ],
    },
  },
  ...
  /* ───── 유료 심리 검사 ───── */
  {
    ...
    detail: {
      ...
      faq: [
        ...
        {
          q: "환불이 가능한가요?",
          a: "검사 링크 발송 전에는 전액 환불 가능합니다. 검사 실시 후에는 환불이 불가합니다. 환불 신청은 카카오톡 gibunstudio로 문의해주세요.",
        },
      ],
    },
  },
