...
export const INNER_CHILD_FUNNEL: MindsFunnelConfig = {
  ...
  // 결제 모달 카피 — 판매 페이지 편익 목차와 톤 일치. 구조/용어가 아니라 "그래서 어떻게
  // 나아지나"로 쓴다(feedback_benefit_translation_copy). 판매→모달 사이 톤이 튀지 않게.
  checkoutCopy: {
    title: "가려둔 곳까지 여는 심층 리포트",
    lead: "당신의 응답으로 쓴, ‘그래서 어떻게 나아질지’까지 담은 심층 리포트예요.",
    includes: [
      "왜 유독 나만 이런지 — 이 마음의 뿌리",
      "같은 상처를 끊고 나아가는 법",
      "관계에서 나를 지키는 더 편한 방식",
      "두 번째 아이 + 오늘의 나에게 건네는 편지",
    ],
  },
};
