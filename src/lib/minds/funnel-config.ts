...
export const INNER_CHILD_FUNNEL: MindsFunnelConfig = {
  ...
  checkoutCopy: {
    ...
    lead: "무료 리포트가 멈춘 그 질문에서 시작합니다. 이 아이가 왜 아직도 그 반응을 반복하는지, 당신의 응답으로 재구성한 전체 구조를 한 편의 리포트로 풀어드려요.",
    includes: [
      "방어 시스템의 정체 — 나를 지키는 동시에 무엇을 대가로 가져가는지",
      "같은 상처가 반복되는 구조 — 당신의 응답으로 재구성한 반복 루프",
      "두 번째 아이의 신호 — 특정 상황에서 먼저 반응하는 또 하나의 아이",
      "이 아이가 정말 원했던 것 — 그리고 지금의 당신이 줄 수 있는 방법",
    ],
  },
};
