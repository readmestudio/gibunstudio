 ...
 * 5문항 축약 흐름.
 *
 *   1. situation      — 성취 영역에서 흔들렸던 한 사건 (근거 앵커)
...
export const FREE_MINDS_STEPS: FreeMindStep[] = [
  {
    id: "situation",
    opening:
      "일·커리어·성취와 관련해서, 최근 마음이 크게 흔들렸던 한 순간을 떠올려보세요. 그때 어떤 상황이었나요?",
    hint: "예: 기대만큼 성과가 안 나왔을 때 · 평가나 마감 앞에서 · 누군가와 비교됐다고 느꼈을 때",
    topic:
      "성취 영역(직장·커리어·학업)에서 떠올린 구체적 한 사건. 시간·장소·계기가 드러나게.",
    minChars: 10,
  },
  {
    id: "active_minds",
  ...
  },
  {
    ...
    hint: "예: \"이번에도 못 하면 끝이야\" · \"남들은 다 하는데 나만 뒤처져\"",
    topic:
