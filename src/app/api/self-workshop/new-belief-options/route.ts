...
- **신념 본문의 핵심 두려움·욕구·관계 구조를 정확히 자극**하는 장면을 새로 창작할 것. 신념의 키워드(예: 부족함·인정·신뢰·통제 등)가 시나리오에 자연스럽게 녹아 있어야 함.
- 신념 축(${sourceLabel})에 따라 장면의 결이 달라야 함:
  · 자기 자신에 대한 신념: 자기 능력·존재감·정체성이 시험되는 장면(결과물 제출 직전, 자기소개·평가 발표, 동료와의 비교가 드러나는 순간 등).
  · 타인에 대한 신념: 타인의 의도·반응·신뢰가 모호하게 드러나는 장면(동료의 짧은 답장, 신뢰가 시험되는 협업, 거리감이 느껴지는 회식 자리 등).
  · 세계에 대한 신념: 환경·구조·예측 불가능성이 드러나는 장면(갑작스런 조직 변화, 통제 밖의 외부 변수, 규칙이 흔들리는 순간 등).
- 직장인 3~15년차 페르소나에 맞는 구체적 디테일(역할·장소·시점·구체 사건)을 한 문장 안에 압축. 단, 매 호출마다 *다른 사건 도메인·다른 장소·다른 시점*에서 새로 길어 올릴 것. 같은 직무·사건이 반복되지 않게.
- **상황 자체만**: 인물의 *감정·반응·결과·자동사고는 절대 포함하지 말 것.* "불안에 휩싸인다", "지쳐버린다", "이번에도 역시" 같은 내적 반응 묘사 금지. 그건 사용자가 다음 단계에서 직접 적어볼 영역.
- 회피해야 할 패턴(반응 묘사가 섞인 잘못된 예): "팀장으로 선정되었지만 회의록 실수를 발견하고 불안에 휩싸이며 다음 회의 준비를 시작하기도 전에 지쳐버립니다." ← 감정 묘사 포함이라 금지.
...
- **신념 본문의 핵심 두려움·욕구·관계 구조를 정확히 자극**하는 장면. 신념의 키워드가 시나리오에 자연스럽게 녹아 있어야 함.
- 신념 축(${sourceLabel})에 따라 장면의 결이 달라야 함:
  · 자기 자신에 대한 신념: 자기 능력·존재감·정체성이 시험되는 장면.
  · 타인에 대한 신념: 타인의 의도·반응·신뢰가 모호하게 드러나는 장면.
  · 세계에 대한 신념: 환경·구조·예측 불가능성이 드러나는 장면.
- 매 호출마다 *다른 사건 도메인·다른 장소·다른 시점*에서 새로 창작. 같은 직무·사건이 반복되지 않게.
