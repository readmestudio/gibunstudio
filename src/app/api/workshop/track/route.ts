...
import { notifyWorkshopBuyAttempt } from "@/lib/minds/notify";
...
export async function POST(req: NextRequest) {
  ...
  const method =
    typeof b.method === "string" && KNOWN_METHODS.has(b.method) ? b.method : null;
