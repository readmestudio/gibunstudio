...
const SAMPLE_CARDS = [
  {
    subtitle: "INTRO",
    title: "당신이 몰래 본 영상이, 당신을 말하고 있다",
    body: `새벽 두 시. 잠이 안 와서 틀어놓은 영상이 있었을 거예요.
...
지금부터 그 이야기를 읽어볼게요.`,
  },
  {
    ...
    body: `당신의 구독 리스트는 37개 채널로 이루어져 있어요. 이 목록은 당신이 세상을 어떤 눈으로 바라보고 어떤 질문을 던지는지 선명하게 보여줘요. 41%를 차지하는 교육/자기계발 채널이 압도적이에요.

단순히 정보를 얻는 게 아니죠. '나는 어떻게 더 나은 사람이 될까?' 늘 묻습니다. 성장을 멈추는 걸 두려워해요.

브이로그/일상 채널(19%)도 중요합니다. 타인의 일상을 엿보는 건 단순 흥미가 아니에요. 다른 삶에서 영감을 얻거나, 자신을 투영하며 위로를 찾는 거죠.

이런 취향은 당신을 상위 3%의 희소한 존재로 만듭니다. 100명 중 3명만이 당신과 비슷한 결을 공유하죠.

육각형 밸런스에서 드러난 당신의 특성
자기초월이 100점으로 정점에 달했고, 자율성이 77점으로 그 뒤를 잇고 있어요. 반면 위험회피는 17점으로 가장 낮은 수치입니다.`,
  },
  {
    subtitle: "Type",
